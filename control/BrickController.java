...
public class BrickController implements Controller {
    ...
    public void gentleKick(int speed, int angle) { //This doesn't work. Its not meant to. Never use it. 
    ...
    @Override
    public void setWheelSpeeds(int leftWheelSpeed, int rightWheelSpeed) { //This is crap. 
